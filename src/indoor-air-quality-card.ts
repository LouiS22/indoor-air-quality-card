...
export class AirQualityCard extends MonitorCardBase {
  ...
  static IMAGE_BASE_URL =
    'https://raw.githubusercontent.com/LouiS22/indoor-air-quality-card/master/resources';

  static async getConfigElement(): Promise<HTMLElement> {
    await import('./editor.js');
    return document.createElement('indoor-air-quality-card-editor');
  }
