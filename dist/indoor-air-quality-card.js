...
`;class cardContent{static generateTitle(e){const s=e.title!==void 0?se` <h1 class="pool-monitor-title">${e.title}</h1> `:se``;return se`${s}`}static generateStatusBadge(e){return se`
      <div class="status-container" @click=${()=>cardContent._moreinfo(e.entity_id)}>
        ...
        ${e.friendly_name?se`<span class="status-friendly-name">${e.friendly_name}</span>`:""}
      </div>
    `}static generateBody(e,s){if(!s)return se` <div class="warning-message">No sensor data available</div> `;const o=s.pct_marker;const r=o<=1?"translateX(0)":o>=99?"translateX(-100%)":"translateX(-50%)";return se`
      <!-- ##### ${s.name} section ##### -->
      <div
        ...
        <div class="section-row">
          ${!s.hide_icon?se`
                <div class="pool-monitor-entity-img">
                  ${s.is_mdi?se`
                        ...
                        ></ha-icon>
                      `:se` <img src="${s.img_src}" style="width: 32px; height: 32px;" /> `}
                </div>
              `:""}
          <div class="sensor-gauge">
            <div class="gauge-marker-zone">
              ...
              >
                ${s.side_align==="right"&&s.state?se`<span class="marker-state">${s.state}</span>`:""}
                ${s.value!=null?`${s.value} ${s.unit}`:"—"}
                ${s.side_align==="left"&&s.state?se`<span class="marker-state">${s.state}</span>`:""}
              </div>
              <div
                class="triangle"
          ...
          ${e.display.icons_inline===false&&(s.battery_icon||s.window_icon||s.fan_icon)?se`
                <div class="right-side-icons">
                  ${s.battery_icon?se`<div style="display:flex; flex-direction:column; align-items:center; color: ${s.battery_color};">
                        <ha-icon icon="${s.battery_icon}" style="--mdc-icon-size: 14px;"></ha-icon>
                        ${s.battery_level!=null?se`<span style="font-size: 8px;">${s.battery_level}%</span>`:""}
                      </div>`:""}
                  ${s.window_icon?se`<ha-icon icon="${s.window_icon}" style="--mdc-icon-size: 14px; color: var(--secondary-text-color);"></ha-icon>`:""}
                  ${s.fan_icon?se`<span class="${s.fan_state==="on"?"fan-animating":""}">
                        <ha-icon icon="${s.fan_icon}" style="--mdc-icon-size: 14px; color: ${s.fan_state==="on"?"var(--state-fan-active-color, var(--state-active-color))":"var(--secondary-text-color)"};"></ha-icon>
                      </span>`:""}
                </div>
              `:""}
        </div>
      ...
      >
        <span>
          ${s.title}
          ${e.display.icons_inline!==false?se`
                ${s.battery_icon?se`<span class="battery-indicator" style="color: ${s.battery_color};">
                      <ha-icon icon="${s.battery_icon}" style="--mdc-icon-size: 14px;"></ha-icon>
                      ${s.battery_level!=null?se`${s.battery_level}%`:""}
                    </span>`:""}
                ${s.window_icon?se`<span class="window-indicator">
                      <ha-icon icon="${s.window_icon}" style="--mdc-icon-size: 14px; color: var(--secondary-text-color);"></ha-icon>
                    </span>`:""}
                ${s.fan_icon?se`<span class="fan-indicator ${s.fan_state==="on"?"fan-animating":""}">
                      <ha-icon icon="${s.fan_icon}" style="--mdc-icon-size: 14px; color: ${s.fan_state==="on"?"var(--state-fan-active-color, var(--state-active-color))":"var(--secondary-text-color)"};"></ha-icon>
                    </span>`:""}
              `:""}
        </span>
        ${s.last_updated?se`<span style="font-size:0.85em;opacity:0.7;">${s.last_updated}</span>`:""}
      </div>
    `}static generateCompactBody(e,s){if(!s)return se` <div class="warning-message">No sensor data available</div> `;return se`
      <!-- ##### ${s.name} section ##### -->
          ...
          ${!s.hide_icon?se`
                <div class="pool-monitor-entity-img">
                  ${s.is_mdi?se`
                        ...
                        ></ha-icon>
                      `:se` <img src="${s.img_src}" style="width: 24px; height: 24px;" /> `}
                </div>
              `:""}
          <div class="sensor-gauge">
            <div class="pool-monitor-container">
              ...
              >
                ...
                ${e.display.icons_inline!==false?se`
                      ...
                      ${s.fan_icon?se`<span class="fan-indicator ${s.fan_state==="on"?"fan-animating":""}">
                            <ha-icon
                              icon="${s.fan_icon}"
                              style="--mdc-icon-size: 12px; color: ${s.fan_state==="on"?"var(--state-fan-active-color, var(--state-active-color))":"white"};"
                            ></ha-icon>
                          </span>`:""}
                    `:""}
                &nbsp;
...
`;class MonitorEditorBase extends i{static{this.styles=Be}setConfig(e){this._config={...e,display:{...Ee,...e.display},colors:{...Pe,...e.colors},sensors:e.sensors||{}}}render(){if(!this.hass||!this._config)return se``;return se`
    ...
    `}_renderSensorFields(e,s,o){return se`
      <div class="sensor-row-content">
        ...
        <ha-entity-picker
          .hass=${this.hass}
          .value=${s.window_entity||""}
          .label=${"Window entity (optional — shows open/closed state)"}
          .includeDomains=${["binary_sensor"]}
          allow-custom-entity
          @value-changed=${s=>this._updateField(e,o,"window_entity",s.detail.value||void 0)}
        ></ha-entity-picker>
        ...
        <ha-entity-picker
          ...
          allow-custom-entity
          @value-changed=${s=>this._updateField(e,o,"fan_entity",s.detail.value||void 0)}
        ></ha-entity-picker>
        ...
        ${this.freeform||!this.registry[e]||s.mode==="quality"?se`
              <div class="sensor-field-row">
                <ha-select
                  .label=${"Mode"}
    ...
    `}_renderAddSensor(){if(this.freeform)return se`
      ...
      `;const e=Object.entries(this.registry).filter(([e])=>!this.sensors[e]).map(([e,s])=>({value:e,label:s.name,category:s.category||"other"}));if(e.length===0)return se`<div class="empty-message">All sensor types are configured.</div>`;const s={water_chemistry:"Essential Water Chemistry",chemical_balance:"Chemical Balance",treatment:"Treatment & Sanitization",equipment:"Equipment & Maintenance",other:"Other"};const o=e.reduce((e,s)=>{const o=s.category;if(!e[o])e[o]=[];e[o].push(s);return e},{});const r=["water_chemistry","chemical_balance","treatment","equipment","other"];return se`
    ...
    `}_toggleExpand(e){this._expanded={...this._expanded,[e]:!this._expanded[e]}}_addPresetSensor(e){const s={...this.sensors,[e]:{entity:""}};this._expanded={...this._expanded,[e]:true};this._fireSensorsChanged(s)}_addFreeformSensor(){const e=this._newSensorType.trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"");if(!e)return;if(this.sensors[e]){const s=this.sensors[e];const o=Array.isArray(s)?[...s]:[s];o.push({entity:""});const r={...this.sensors,[e]:o};const l=`${e}-${o.length-1}`;this._expanded={...this._expanded,[l]:true};this._fireSensorsChanged(r)}else{const s={...this.sensors,[e]:{entity:""}};this._expanded={...this._expanded,[e]:true};this._fireSensorsChanged(s)}this._newSensorType=""}_removeSensor(e,s){const o=this.sensors[e];if(Array.isArray(o)){const r=o.filter((e,o)=>o!==s);if(r.length===0){const{[e]:s,...o}=this.sensors;this._fireSensorsChanged(o)}else if(r.length===1)this._fireSensorsChanged({...this.sensors,[e]:r[0]});else this._fireSensorsChanged({...this.sensors,[e]:r})}else{const{[e]:s,...o}=this.sensors;this._fireSensorsChanged(o)}}_updateField(e,s,o,r){const l=this.sensors[e];if(Array.isArray(l)){const u=[...l];u[s]={...u[s],[o]:r};if(r===void 0||r==="")delete u[s][o];this._fireSensorsChanged({...this.sensors,[e]:u})}else{const s={...l,[o]:r};if(r===void 0||r==="")delete s[o];this._fireSensorsChanged({...this.sensors,[e]:s})}}_fireSensorsChanged(e){this.dispatchEvent(new CustomEvent("sensors-changed",{bubbles:true,composed:true,detail:{sensors:e}}))}}__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"hass",void 0);__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"sensors",void 0);__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"registry",void 0);__decorate([n$1({type:Boolean})],MonitorSensorEditor.prototype,"freeform",void 0);__decorate([r$1()],MonitorSensorEditor.prototype,"_expanded",void 0);__decorate([r$1()],MonitorSensorEditor.prototype,"_newSensorType",void 0);if(!customElements.get("monitor-sensor-editor"))customElements.define("monitor-sensor-editor",MonitorSensorEditor);let qe=class AirQualityCardEditor extends MonitorEditorBase{get sensorsRegistry(){return Te}get hasPresets(){return true}renderSensorSection(){return se`
      ...
      ></monitor-sensor-editor>
    `}};qe=__decorate([t$2("indoor-air-quality-card-editor")],qe);const Ue=Object.freeze(Object.defineProperty({__proto__:null,get AirQualityCardEditor(){return qe}},Symbol.toStringTag,{value:"Module"}));export{Oe as AirQualityCard};
